...
class PhoneTest < MiniTest::Unit::TestCase
  ...
  def test_area_code
    ...
    assert_equal "123", number.number.area_code
  end
  ...
  def test_pretty_print_with_full_us_phone_number_too_short
    number = Phone.new("012345678")
    assert_equal "(000) 000-0000", number.number.to_s
  end

  def test_pretty_print_with_full_us_phone_number_too_long
